module "dataform" {
  ...
  github_public_key  = "ecdsa-sha2-nistp521 AAAAE2VjZHNhLXNoYTItbmlzdHA1MjEAAAAIbmlzdHA1MjEAAACFBACD/4Ws33w6w+TM9vdFmQuzq82bud6+D+nLaVWBvU5701FJf9NClZl6S4RFUx8L8krmG0ZjO3nv6HAwZQqPRjyPHgCTyXZ4d1lwH/DnYsBt4xZI2cp5NmC04tdpYjwtIlHLylenkdyLbwWRGUCwdxXP4GrF6+SRSGHy0RiVWUtgiApNuA== "
  default_branch     = "main"
